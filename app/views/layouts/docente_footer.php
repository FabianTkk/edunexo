<?php
// app/views/layouts/docente_footer.php
?>
        </div><!-- /page-content -->
    </main>
</div><!-- /dash-layout -->
...
async function loadPage(url, pushState = true) {
    ...
    try {
        ...
        // script se incluye en todas las paginas docente, asi que el HTML
        // de CUALQUIER modulo siempre contendria el string 'class="auth-page"'
        // si se buscara como texto plano (matchea con su propio codigo fuente).
