...
<head>
    ...
    <title>Panel Docente &mdash; EduNexo</title>
...
<div class="dash-layout">
    ...
    <aside class="sidebar" id="sidebar" role="navigation" aria-label="Menu principal">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="/edunexo/docente/materias" class="nav-item">
    ...
    <main class="dash-main">
        <header class="dash-topbar">
            <div class="dash-topbar-title">Panel Docente</div>
        ...
        <div class="dash-content">
            ...
            <div class="stats-grid">
                <div class="stat-card" style="animation-delay:.05s">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-trend"><?php echo $stats['mis_estudiantes']; ?> con reportes tuyos</div>
                    </div>
                </div>
            ...
            <div class="data-card">
                ...
                <div class="quick-grid">
                    <a href="#" class="quick-btn"><span class="qi">&#10133;</span>Nuevo reporte</a>
                    <a href="#" class="quick-btn"><span class="qi">&#127891;</span>Ver estudiantes</a>
                    <a href="#" class="quick-btn"><span class="qi">&#128202;</span>Mis reportes</a>
                    <a href="#" class="quick-btn"><span class="qi">&#128241;</span>Estado WA</a>
                </div>
            </div>
